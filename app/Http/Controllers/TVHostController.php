...
class TVHostController extends Controller
{
    /**
    ...
    {
        $curlHandles = [];
        $curlUrl = ['https://api.themoviedb.org/3/person/' . $id. '?append_to_response=tv_credits,movie_credits'];
        $dataRequests = [];
        $curlError = [];
    ...
    //    dd($host);
        ...
        // dd($reviews);
        return view('layouts.show4', compact('host'));
    }
